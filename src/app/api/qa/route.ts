...
- heat_violation: PPF/컬러PPF/PWF 시공 중 "열을 가해" "열 성형" "열로 늘려" "히팅건" "히트건" "열풍" "포스트 히팅" 표현 사용 여부. 이 세 가지는 열 성형을 진행하지 않음. 단, 랩핑/크롬죽이기/썬팅 시공기에서는 열 사용이 정상이므로 허용
...
### [품질 평가] 각 항목 0~10점
- char_count: [사진 N] 태그를 제거하고 공백을 제거한 순수 텍스트 글자수 기준. 1800자 이상이면 10점, 1500~1799자면 5점, 미만이면 0점. 실제 글자수를 comment에 명시
