...
- representative_career: 진준호 대표에게 경력 연수 언급 ("N년 경력" "오랜 경력" "수십 년간" 등). 30년 경력은 이팀장님의 것이며 대표에게 붙이면 위반. 대표 소개는 "3M 프리퍼드 인스톨러" "국가 정비 자격증" 같은 자격 중심만 허용
- customer_quote: 고객 말을 직접 인용 (따옴표 여부 불문). "이걸 진작 할 걸" "어차피 할 거면 제대로" "완전히 다른 차 같다" "이게 진짜 PWF구나" 같은 따옴표 인용 모두 위반
- panel_listing: 패널을 하나하나 나열 (보닛, 펜더, 도어, 사이드미러, 루프, 트렁크... 식으로 4개 이상 연속 나열)
- time_sequence_listing: "다음은~" "그 다음~" "이어서~" "마지막으로~" 같은 시간순 연결어가 부위명과 결합돼 시공 순서대로 부위를 옮겨다니는 구조
- careful_part_fabrication: 사용자 입력에 까다로운 부위 정보가 없는데 본문에 "까다로웠다" "신경 썼다" "공들였다" 같은 어휘가 등장. 또는 "가장 까다로웠던 부분은~" "두 번째로 신경 쓴 부분은~" 같은 번호 매기기
- mirror_difficulty: 사이드미러를 까다로운 부위·신경 쓴 부위로 묘사 (어떤 경우에도 사이드미러는 까다로운 부위가 아님)
- numbered_listing: "첫째," "둘째," "셋째," 또는 "1)" "2)" "3)" 또는 "차별점1:" 같은 번호 매기기로 강점·차별점·부위·과정을 나열
- forbidden_closing: 금지 마무리 표현. "긴 글 읽어주셔서 감사합니다" "오늘도 한 대의 작품" "이런 순간이 이 일을 하는 이유" "~ 자부합니다"로 끝맺기
- differentiation_listing: 차별점/강점을 번호나 리스트로 나열 ("첫째~ 둘째~ 셋째~", "차별점1:~ 차별점2:~" 식). 자신감은 시공 이야기 흐름에 녹여야 하며 나열하면 위반
- ad_tone: 광고 전단지/회사 소개서 톤. "저희 프로이즘은 ~합니다. 또한 ~합니다. 그리고 ~합니다" 식 자랑 나열, 본문 중간에 회사 소개 섹션 삽입
- excessive_pride: "압도적" "독보적" "전국 최고" "업계 1위" 같은 선언을 글당 2회 이상 사용, 또는 한 문단에 자신감 표현 3개 이상 몰아 쓰기
