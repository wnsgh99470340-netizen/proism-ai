...
【1단계 - 인사 도입】
- 반드시 "안녕하세요?" 로 시작합니다.
- 오늘 다룰 시공 종류에 맞는 자기소개를 한 줄 씁니다. (예: "오늘은 BMW M4 컴페티션의 PPF 전체 시공 이야기를 들려드릴게요.")
- 반드시 "3M 프로이즘 서초점 대표 진준호 입니다." 로 도입을 마무리합니다.
...
- 제품 특성: 사용하는 제품(3M 스카치가드 PPF 프로 시리즈, PPF Pro4 등)의 특성과 장점을 설명합니다.
...
- 문단은 2~4줄로 끊어 씁니다.
- 총 글자수는 2000~4000자를 맞춥니다.
- 허위/과장 표현은 절대 하지 않습니다. 사실만 자연스럽게 씁니다.`,
  },
  {
    id: 'perf-marketer',
    name: '퍼포먼스 마케터',
...
7. 글자수 적정성 (15점): 2000~4000자 범위 내인지
