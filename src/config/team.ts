...
- 제품 특성: 사용하는 제품의 특성과 장점을 설명합니다. (PPF는 고객이 선택한 등급만 사용: 3M PPF 시리즈 50(엔트리급)/100(중급)/150(고급), 3M PRO 200 스카치가드(최상급). 썬팅/랩핑은 고객이 입력한 제품명만 사용 — 존재하지 않는 제품명 절대 사용 금지)
...
- PPF 제품은 4개 등급만 사용합니다: 3M PPF 시리즈 50(엔트리급), 3M PPF 시리즈 100(중급), 3M PPF 시리즈 150(고급), 3M PRO 200 스카치가드(최상급). 고객이 선택한 등급에 맞는 정확한 제품명을 사용합니다. 썬팅/랩핑 제품은 고객이 입력한 제품명만 사용합니다. 존재하지 않는 제품명은 절대 사용하지 않습니다.`,
  },
  {
    id: 'perf-marketer',
    name: '퍼포먼스 마케터',
